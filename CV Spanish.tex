...
\cventry{Febrero  2020 - \emph{presente}}{Clavis Legal Abogados}{}{}{}{Socio líder del área de regulación financiera, tecnologías de la información, e innovación. Me desempeño como asesor y consultor legal en materias de regulación financiera, comercio electrónico, protección de datos personales, portabilidad financiera, sistemas de cumplimiento normativo, entre otras temáticas afines. Dentro del portafolio de clientes se encuentran \textit{retailers}, empresas fintech, instituciones financieras, plataformas de comercio electrónico, e integradores de aplicativos y brókeres de datos. \textbf{Principales Logros}: He tenido la oportunidad de diseñar los mecanismos contractuales de integración y envió estandarizado de información con ocasión de la primera plataforma de portabilidad financiera, integradora de proveedores financieros de múltiples industrias (bancos, autofinance, CCAFs, CACs, entre otros). - Actualmente, lidero la implementación por un grupo económico local, participe en más de 12 sectores, con presencia en toda la región (Perú, Colombia, Brasil, México) de un modelo global de PIMS (sistema de manejo de datos personales) así como evaluaciones de impacto en materia de protección de datos (DPIA) considerando los requerimientos de cada jurisdicción relevante. } 
...
\cvitemwithcomment{Informática}{Ms. Office Apps (avanzado), \LaTeX (intermedio), R (intermedio), Python (básico), PKI}{}
\end{document}
